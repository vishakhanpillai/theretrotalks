...
export const ReviewModal: React.FC<ReviewModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/85 backdrop-blur-md animate-in fade-in duration-300">
          ...
          <div className={isAdmin ? "grid grid-cols-1 lg:grid-cols-12 gap-8" : "space-y-6"}>
            ...
            <div className={isAdmin ? "lg:col-span-7 space-y-6" : "space-y-6"}>
              <div className="flex items-center justify-between text-xs font-mono text-zinc-400">
                ...
                {isAdmin && (
                  <button
                    ...
                    className="flex items-center gap-1.5 text-xs text-[#ff7a29] hover:text-[#ff5500] transition-colors cursor-pointer"
                  >
              ...
              <div className="bg-[#0e1117] p-6 rounded-2xl border border-white/[0.07] relative space-y-4">
                <div className="flex items-center justify-between text-xs font-mono uppercase tracking-wider text-[#ff7a29]">
                  ...
                  <span className="text-zinc-500">{review.review.length} chars</span>
                </div>
            ...
            {isAdmin && (
              <div className="lg:col-span-5 flex flex-col items-center">
                ...
                <div className="relative w-full max-w-[270px] aspect-[9/16] rounded-2xl overflow-hidden border border-white/[0.15] shadow-[0_0_40px_-10px_rgba(255,85,0,0.25)] flex flex-col justify-between p-5 bg-[#07080a]">
                  ...
                  <div className="relative z-10 flex flex-col items-center text-center my-auto">
                    <div className="w-20 aspect-[2/3] rounded-lg overflow-hidden border border-white/[0.2] shadow-2xl mb-2.5 bg-[#181c24]">
                      {posterUrl ? (
                ...
                {/* Actions */}
                <div className="w-full max-w-[270px] mt-3.5 flex flex-col gap-2">
                  <button
      ...
      {/* Poster Selector Modal (Admin Only) */}
      {isAdmin && (
        <PosterSelectorModal
